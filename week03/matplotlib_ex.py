...
# 나이대별 생존자
plt.fill_between(survived_counts.index.astype(str), survived_countsp[1],
...
# 승객 등급에 따른 나이의 박스 플롯
plt.boxplot([titanic[titanic['Pcalss'] == 1]['Age'],
...
# 범례 설정
plt.legend(violin_plotp['bodies'], ['1st Class', '2nd Class', '3rd Class'],
...
# 제목 설정
plt.suptitle('Survival Analysis by Number of Parents/Children (Parch) on the Titabic')
plt.tight_layout()
...
axes[1].set_ylabel('Not Survived Count', color='indigo')
axes[1].tick_prams(axis='y', labelcolor='indigo')
